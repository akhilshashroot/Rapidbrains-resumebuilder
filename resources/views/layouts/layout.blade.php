...
<html lang="en">
	...
	<title>RapidBrains Resume Builder</title>
		...
		<meta property="og:title" content="HASHROOT | ACCOUNTS PORTAL" />
		<meta property="og:url" content="https://accountsnew.hashroot.org/" />
...
.toast {
    ...
    --bs-toast-header-color: #ffffff !important;

    --bs-toast-header-bg: #d9214e !important;
...
.sk{
	...
	<body data-kt-name="metronic" id="kt_app_body" data-kt-app-layout="light-header" data-kt-app-header-fixed="true" data-kt-app-toolbar-enabled="true" class="app-default">
		<!--begin::Theme mode setup on page load-->
		     ...
		     <!--begin::Toast-->
			 <div class="position-fixed top-0 end-0 p-3 z-index-33">
    <div id="kt_docs_toast_toggle" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
	<div data-bs-dismiss="toast" class="">
           
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<span class="svg-icon svg-icon-1 sk" style="
    padding-left: 254px;
">
...
<span  id="toast-msg" style="
    color: #fff;
    font-size: 14px;text-align: center;  padding-left: 44px;
">
						...
						<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
							...
							<div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_app_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="{default: 'append', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_body', lg: '#kt_app_header_wrapper'}">
								...
								<div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
									...
									@if(Auth::user()->role==1)<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
										<!--begin:Menu link-->
										<a href="{{route('users.index')}}">	<span class="menu-link">
