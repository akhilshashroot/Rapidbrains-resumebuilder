...
<th style="text-align: center;;width:100px;">
    ...
    @for($i=0;$i<$hashrootCount;$i++)
    <tr style="font-size:12px;">							

        <td>{{$hashrootIn[$i]['id']}}</td>
        <td>{{$invo_details_hsn}}</td>
     
        <td>{{$hashrootIn[$i]['description']}}</td>
        <td>{{$hashrootIn[$i]['quantity']}}</td>
        <td>{{$hashrootIn[$i]['total']}}</td>
        @if($gst)
        <td>{{$gst}}</td>
        <td>{!!$invo_details->currency!!}&nbsp;{{$hashrootIn[$i]['gst_toal']}}</td>
        @else
        <td>-</td>
        <td>{!!$invo_details->currency!!}&nbsp;{{$hashrootIn[$i]['total']}}</td>
        @endif
...
<tr>
    ...
    <br /> <br />  <br /> 
            ...
            <td style="text-align:left;width:100px;">{!!$invo_details->currency!!}&nbsp;{!!$sub_total!!}</td>
