								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_62cfa326adaed">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_62cfa326adaed" data-allow-clear="true">
																<option></option>
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
										...
										<div class="card-body pt-9 pb-0">
													...
													<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
														...
														<div class="d-flex flex-column">
															...
															<div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
																...
																<!--end::Svg Icon-->{{$data['profile']->role->title}}</a>
											...
											<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
												...
												<li class="nav-item mt-2">
													<a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="{{route('view.profile')}}">Overview</a>
												</li>
                                                <!-- <li class="nav-item mt-2">
													<a class="nav-link ms-0 me-10 py-5 " href="../../demo1/dist/account/overview.html">Edit Profile</a>
												</li> -->
												<!--end::Nav item-->
												<!--begin::Nav item-->
									...
									<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
										...
										<div class="card-header cursor-pointer">
											...
											<!--end::Card title-->
											<!--begin::Action-->
											<a class="btn btn-primary align-self-center" id="edit-profile">Edit Profile</a>
											<!--end::Action-->
										</div>
										<!--begin::Card header-->
										<!--begin::Card body-->
										<div class="card-body p-9">
											...
											<div class="row mb-7">
												...
												<!--begin::Col-->
												<div class="col-lg-8"> 
													<span class="fw-bold fs-6 text-gray-800 edit-d">{{Auth::user()->name}}</span>
                                                    <input type="text" name="name" id="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 edit-s"  style=display:none; placeholder="Full Name" value="{{Auth::user()->name}}">
											...
											<!--end::Row-->
											<!--begin::Input group-->
											<div class="row mb-7 edit-d">
												<!--begin::Label-->
												<label class="col-lg-4 fw-semibold text-muted">Company</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
													<span class="fw-semibold text-gray-800 fs-6 ">{{$data['profile']->client->name}}</span>
                                                </div>
												<!--end::Col-->
											</div>

                                            <div class="row mb-7 edit-s" style=display:none;>
												<!--begin::Label-->
												<label class="col-lg-4 fw-semibold text-muted">Password</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
                                                    <input type="text" name="password" id="password" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Password" value="">
                                                </div>
												<!--end::Col-->
											</div>
											<!--end::Input group-->
											<!--begin::Input group-->
                                            <div class="edit-s" style=display:none;>
                                            <div class="card-footer d-flex justify-content-end py-6 px-9"> 
													<button type="reset" class="btn btn-light btn-active-light-primary me-2" id="discard">Discard</button>
          ...
          success:function(response){
            ...
            if (response.error=='402') {
				...
				Swal.fire({
								 ...
								 window.location = '/recruiter/myprofile';
							});
