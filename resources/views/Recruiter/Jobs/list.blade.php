											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                        ...
                                                        <th class="min-w-100px">UPLOAD PROFILE</th>
                                                       ...
                                                       {{ $job->location}}						
														...
														<td class="text-end">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<a href="{{route('jobs.list', ['id' =>  $job->id])}}" class="menu-link px-3" target="_blank">View</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
																<a data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer" data-id="{{$job->id}}" style="cursor: pointer;" id="edit-customer" class="menu-link px-3">Edit</a>
																</div>
																@if($job->status==1) 	<div class="menu-item px-3">
																	<a  class="menu-link px-3" class="bi bi-x-lg" data-id="{{ $job->id }}" id="delete-close-job"  style="cursor: pointer;">Close</a>
																</div>
																@endif
															</div>
															<!--end::Menu-->
                                                        ...
                                                        @if($job->status==1)   <a  id="upload" data-id="{{ $job->id}}" data-bs-toggle="modal"
														 data-bs-target="#kt_modal_add_talent" style="cursor: pointer;">
														 <img width="70" height="25"  src="{{asset('assets\img\recruiter\upload-svgrepo-com.svg')}}">
														</a>@endif
														</td>
													</tr>
                                                    @endforeach
