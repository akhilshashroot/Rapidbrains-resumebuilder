									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<li class="breadcrumb-item text-muted">
												<a href="{{route('jobs.index')}}" class="text-muted text-hover-primary">Job</a>
											</li>
											<!--end::Item-->
											<!--begin::Item-->
											...
											<div class="d-flex flex-column flex-lg-row mb-17">
												...
												<div class="flex-lg-row-fluid me-0 me-lg-20">
													...
													<div class="mb-17">
														...
														<!--end::Accordion-->
														<!--begin::Apply-->
													@if($jobs->status==1)	<a id="upload" data-id="{{ $jobs->id}}" data-bs-toggle="modal" data-bs-target="#kt_modal_add_talent"  class="btn btn-sm btn-primary mt-5">Upload Profile</a>@endif
														<!--end::Apply-->
													</div>
													<!--end::Job-->
													<!--begin::Job-->
