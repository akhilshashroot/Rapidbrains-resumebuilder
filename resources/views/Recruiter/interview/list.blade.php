							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Interviews</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<li class="breadcrumb-item text-muted">Interviews</li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-toolbar">
												...
												begin::Svg Icon | path: icons/duotune/arrows/arr078.svg-->
													...
													<!-- <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer" id="add-customer">Add Job</button> -->
													<!--end::Add customer-->
												</div>
												<!--end::Toolbar-->
												<!--begin::Group actions-->
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="">#</th>
														<th  class="min-w-100px" style="width: 133.969px;">PROFILE ID</th>
														<th  class="min-w-100px" style="width: 176.047px;">CANDIDATE NAME</th>
														<th class="min-w-100px"> INTERVIEWERS</th>
														<th class="min-w-100px">REVIEW</th>
														<th class="min-w-100px" style="width: 166.047px;" >MODE OF INTERVIEW</th>
														<th class="min-w-100px">STATUS</th>
                                                        <th class="min-w-100px" style="width: 109.719px;">INTERVIEW SLOT</th>
                                            ...
                                            <th class="">#</th>
												...
												<tbody class="fw-semibold text-gray-600">
													...
													<tr>
														...
														<a  class="text-gray-800 text-hover-primary fs-5 fw-bold" href="{{route('talents.list', ['id' =>  $interview->id])}}" target="_blank">  {{ $interview->talent_id}}</a>					
															</td>	
                                                        <td class="fw-bold">
                                                        {{$interview->name}}				
														</td>
                                                        ...
                                                        <td class="fw-bold">
														@if($interview->status=='open')<div  class="badge badge-light-dark">
															OPEN
															</div>@endif	
															@if($interview->status=='shortlisted')<div  class="badge badge-light-primary">
															SHORTLISTED
															</div>@endif	
															@if($interview->status=='selected')<div class="badge badge-light-success">
															SELECTED
															</div>@endif	
															@if($interview->status=='joined')<div class="badge badge-light-warning">
															JOINED
															</div>@endif	
															@if($interview->status=='scheduled')<div class="badge badge-light-info">
															SCHEDULED
															</div>@endif	
															@if($interview->status=='noappear')<div  class="badge badge-light-danger">
															DIDN'T APPEAR
															</div>@endif	
															@if($interview->status=='rejected')<div  class="badge badge-light-danger">
															REJECTED
															</div>@endif	
															@if($interview->status=='declined')<div  class="badge badge-light-dark">
														    DECLINED
															</div>@endif	
															@if($interview->status=='discontinued')<div  class="badge badge-light-dark">
															DISCONTINUED
															</div>@endif				
														</td>
                                                        <td class="fw-bold">
														...
														<td class="fw-bold">
														@if($interview->priority=='low')<div  class="badge badge-circle badge-info">
															Low
															</div>@endif	
														@if($interview->priority=='high')<div class="badge badge-circle badge-danger">
															High
															</div>@endif				
														</td>
														...
														<td class="text-end">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<div class="menu-item px-3">
																	<a  class="menu-link px-3" class="bi bi-x-lg" data-id="{{ $interview->int_id }}" id="delete-close-interview"  style="cursor: pointer;">Delete</a>
																</div>
...
//       });
		...
		$(document).on('click','#delete-close-interview',function(){
      event.preventDefault();
	  var int_id = $(this).data('id');
      const url = 'interview/delete/'+int_id;
	        
      swal({
          title: 'Are you sure?',
          text: "Are you sure you want to delete selected interview?",
          icon: 'warning',
          buttons: ["Cancel", "Yes!"],
          }).then(function(value) {
          if (value) {
