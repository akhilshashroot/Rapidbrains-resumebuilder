					...
					<div class="card card-flush w-md-650px py-5">
						<div class="card-body py-15 py-lg-20">
							...
							<div class="mb-7">
									...
									<img alt="Logo" src="{{asset('stakefield-1-01.svg')}}" class="h-40px" />
							
							</div>
							<!--end::Logo-->
							<!--begin::Title-->
							<h1 class="fw-bolder text-gray-900 mb-5">Thank you confirming slot </h1>
							<!--end::Title-->
							<!--begin::Text-->
							<div class="fw-semibold fs-6 text-gray-500 mb-7">HR will contact you for further details.
							</div>
							<!--end::Text-->
							<!--begin::Illustration-->
							<div class="mb-0">
