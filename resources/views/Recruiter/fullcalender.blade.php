...
<style>
#p1 {background-color:#33eb26;margin-right: 13px;padding: 7px;}
#p2 {background-color:#eb9326;margin-right: 13px;padding: 7px;}
#p3 {background-color:#64a1dd;padding: 7px;}
.fc-content{padding: 0.25rem 0.25rem;}
...
<div id="kt_app_content_container" class="app-container container-xxl">
									...
									<div class="card">
										...
										<div class="card-header">
											...
											<div id="p1">Joining Date </div>
<div id="p2">Payout Date </div>
<div id="p3">Scheduled Date </div>
											</div>
										</div>
										<!--end::Card header-->
										<!--begin::Card body-->
												...
												<div class="modal-body pt-0 pb-20 px-lg-17">
													...
													<div class="d-flex">
														...
														<div class="mb-9">
															...
															<div class="d-flex align-items-center mb-2">
																<span class="fs-3 fw-bold me-3" data-kt-calendar="event_name" id="eventTitle"></span>
																<span class="badge badge-light-success" data-kt-calendar="all_day"></span>
															</div>
															<!--end::Event name-->
															<!--begin::Event description-->
															<div class="fs-6" data-kt-calendar="event_description" id="event_description"></div>
													...
													<div class="d-flex align-items-center mb-2">
														...
														<div class="fs-6">
															...
															<span data-kt-calendar="event_start_date" id="event_start_date"></span>
														</div>
													...
													<div class="d-flex align-items-center mb-9">
														...
														<div class="fs-6">
															...
															<span data-kt-calendar="event_end_date" id="event_end_date"></span>
														</div>
									...
									<!--begin::Modal - New Product-->
									<div class="modal show" id="kt_modal_view_event" tabindex="-1" aria-hidden="true">
										<!--begin::Modal dialog-->
										<div class="modal-dialog modal-dialog-centered mw-650px">
											<!--begin::Modal content-->
											<div class="modal-content">
	...
	eventClick: function (event) {
						$.ajax({
                                ...
                                success: function (response) {
									...
									$('#event_start_date').html(response.start);
									$('#event_end_date').html(response.end);
