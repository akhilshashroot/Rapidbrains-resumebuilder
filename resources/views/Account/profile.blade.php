									...
									<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
										...
										<div class="card-body p-9">
											...
											<div class="row mb-7">
												...
												<!--begin::Col-->
												<div class="col-lg-8"> 
													<span class="fw-bold fs-6 text-gray-800 edit-d">{{Auth::user()->username}}</span>
                                                    <input type="text" name="name" id="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 edit-s"  style=display:none; placeholder="Full Name" value="{{Auth::user()->username}}">
