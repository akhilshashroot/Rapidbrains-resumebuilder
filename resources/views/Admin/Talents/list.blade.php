													...
													<tbody class="fw-semibold text-gray-600">
														...
														<a  class="text-gray-800 text-hover-primary fs-5 fw-bold" href="{{route('talents.list', ['id' =>  $talent->id])}}" target="_blank">  {{ $talent->talent_id}}</a>					
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<a href="{{route('admin.talents.list', ['id' =>  $talent->id])}}"   target="_blank" class="menu-link px-3">View</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
										...
										<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
											...
											<div class="modal-dialog modal-dialog-centered mw-650px">
												...
												<div class="modal-content">
													<!--begin::Form-->
													<form class="form"  method="post" id="kt_modal_add_customer_form" data-kt-redirect="{{route('talents.index')}}">
														@csrf
													<!--begin::Modal header-->
