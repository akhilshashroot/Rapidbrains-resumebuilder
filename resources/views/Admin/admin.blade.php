        ...
        <div class="card h-lg-100">
            ...
            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                ...
                <div class="d-flex flex-column my-7">
                    ...
                    <!--begin::Follower-->
                    <div class="m-0">
                        <a href="{{route('job.index')}}"><span class="fw-semibold fs-6 text-gray-400">Total Jobs</span></a>
                    </div>
                    <!--end::Follower-->
                </div>
                <!--end::Section-->
        ...
        <div class="card h-lg-100">
            ...
            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                ...
                <div class="d-flex flex-column my-7">
                    ...
                    <!--begin::Follower-->
                    <div class="m-0">
					<a href="{{route('talents.index')}}"><span class="fw-semibold fs-6 text-gray-400">Total Profiles</span></a>
                    </div>
                    <!--end::Follower-->
                </div>
                <!--end::Section-->
        ...
        <div class="card h-lg-100">
            ...
            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                ...
                <div class="d-flex flex-column my-7">
                    ...
                    <!--begin::Follower-->
                    <div class="m-0">
					<a href="{{route('talents.index')}}"><span class="fw-semibold fs-6 text-gray-400">Selected Profiles</span></a>
                    </div>
                    <!--end::Follower-->
                </div>
                <!--end::Section-->
        ...
        <div class="card h-lg-100">
            ...
            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                ...
                <div class="d-flex flex-column my-7">
                    ...
                    <!--begin::Follower-->
                    <div class="m-0">
					<a href="{{route('talents.index')}}"><span class="fw-semibold fs-6 text-gray-400">Joined Profiles</span></a>
                    </div>
                    <!--end::Follower-->
                </div>
                <!--end::Section-->
        ...
        <div class="card h-lg-100">
            ...
            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                ...
                <div class="d-flex flex-column my-7">
                    ...
                    <!--begin::Follower-->
                    <div class="m-0">
					<a href="{{route('talents.index')}}"><span class="fw-semibold fs-6 text-gray-400">Scheduled Interviews</span></a>
                    </div>
                    <!--end::Follower-->
                </div>
                <!--end::Section-->
        ...
        <div class="card h-lg-100">
            ...
            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                ...
                <div class="d-flex flex-column my-7">
                    ...
                    <!--begin::Follower-->
                    <div class="m-0">
					<a href="{{route('talents.index')}}"><span class="fw-semibold fs-6 text-gray-400">  Pending Interviews</span></a>
                    </div>
                    <!--end::Follower-->
                </div>
                <!--end::Section-->
	...
	<div class="col-sm-6 col-xl-3 mb-5 mb-xl-10">
        ...
        <div class="card h-lg-100">
            ...
            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                ...
                <div class="d-flex flex-column my-7">
                    <!--begin::Number-->
                    <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{$data['completed']}}</span>
                    <!--end::Number-->
                    <!--begin::Follower-->
                    <div class="m-0">
					<a href="{{route('talents.index')}}"><span class="fw-semibold fs-6 text-gray-400">  Completed Interviews</span></a>
                    </div>
                    <!--end::Follower-->
                </div>
                <!--end::Section-->
	...
	<div class="col-sm-6 col-xl-4 mb-5 mb-xl-10">
        ...
        <div class="card h-lg-100">
            ...
            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                ...
                <div class="d-flex flex-column my-7">
                    <!--begin::Number-->
                    <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{$data['recruiter']}}</span>
                    <!--end::Number-->
                    <!--begin::Follower-->
                    <div class="m-0">
                        <a href="{{route('recruiterlogin.index')}}"><span class="fw-semibold fs-6 text-gray-400">  Recruiters</span></a>
                    </div>
                    <!--end::Follower-->
                </div>
                <!--end::Section-->
    ...
    <div class="col-sm-6 col-xl-4 mb-5 mb-xl-10">
        ...
        <div class="card h-lg-100">
            ...
            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                ...
                <div class="d-flex flex-column my-7">
                    <!--begin::Number-->
                    <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{$data['company']}}</span>
                    <!--end::Number-->
                    <!--begin::Follower-->
                    <div class="m-0">
					<a href="{{route('company.index')}}"><span class="fw-semibold fs-6 text-gray-400">Company</span></a>
                    </div>
                    <!--end::Follower-->
                </div>
                <!--end::Section-->
    ...
    <div class="col-sm-6 col-xl-4 mb-5 mb-xl-10">
        ...
        <div class="card h-lg-100">
            ...
            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                ...
                <div class="d-flex flex-column my-7">
                    <!--begin::Number-->
                    <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{$data['category']}}</span>
                    <!--end::Number-->
                    <!--begin::Follower-->
                    <div class="m-0">
					<a href="{{route('category.index')}}"><span class="fw-semibold fs-6 text-gray-400">  Category</span></a>
                    </div>
                    <!--end::Follower-->
                </div>
                <!--end::Section-->
