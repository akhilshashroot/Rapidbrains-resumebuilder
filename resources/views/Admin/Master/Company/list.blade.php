										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-title">
												...
												<div class="d-flex align-items-center position-relative my-1">
													...
													<!--end::Svg Icon-->
													<input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Companies" />
												</div>
												<!--end::Search-->
											</div>
											<!--begin::Card title-->
											...
											<div class="card-toolbar">
												...
												<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
													...
													<!--end::Export-->
													<!--begin::Add customer-->
													<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Company</button>
													<!--end::Add customer-->
												</div>
												<!--end::Toolbar-->
												<!--begin::Group actions-->
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-125px">Payout Percentage</th>
														<th class="min-w-125px">Payout Cycle</th>
													...
													<tr>
														...
														<td>
															<div class="form-check form-check-sm form-check-custom form-check-solid">
																<input class="form-check-input" name="deleteArray[]" type="checkbox" value="{{$list->id}}" />
															</div>
														</td>
														<!--end::Checkbox-->
														<!--begin::Name=-->
														<td>
															{{$list->payout_percentage}}
														</td>
														<td>
															{{$list->payout_cycle}}
														</td>
														...
														<td class="text-end">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<div class="menu-item px-3">
																	<a onclick="editBox({{$list->id}})" class="menu-link px-3">Edit</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
																	<a href="#" class="menu-link px-3" data-id="{{$list->id}}" data-kt-customer-table-filter="delete_row">Delete</a>
																</div>
																<!--end::Menu item-->
															</div>
															<!--end::Menu-->
									...
									<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
										...
										<div class="modal-dialog modal-dialog-centered mw-650px">
											...
											<div class="modal-content">
												<!--begin::Form-->
												<form class="form"  method="post" id="kt_modal_add_customer_form" data-kt-redirect="{{route('company.index')}}">
													@csrf
                                                <!--begin::Modal header-->
													<div class="modal-header" id="kt_modal_add_customer_header">
														<!--begin::Modal title-->
														<h2 class="fw-bold" id="modal-head">Add Company</h2>
														<!--end::Modal title-->
														<!--begin::Close-->
													...
													<div class="modal-body py-10 px-lg-17">
														...
														<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
															...
															<div class="fv-row mb-7">
																<!--begin::Label-->
																<label class="required fs-6 fw-semibold mb-2">Payout Percentage</label>
																<!--end::Label-->
																<!--begin::Input-->
																<input type="text" class="form-control form-control-solid" placeholder="Payout Percentage" name="percentage" id="percentage" value=""/>
																<!--end::Input-->
															</div>
															...
															<div class="fv-row mb-7">
																...
																<label class="fs-6 fw-semibold mb-2">
																	<span class="required">Payout Cycle</span>
																</label>
																<!--end::Label-->
																<!--begin::Input-->
																<input type="text" class="form-control form-control-solid" placeholder="Payout Cycle" name="cycle" id="cycle" value="" required/>
                                                                <input type="hidden" class="form-control form-control-solid" name="companyid" id="companyid" value=""/>
																<!--end::Input-->
															</div>
															<!--end::Input group-->
															<!--begin::Input group-->
            ...
            o = r.querySelector("#kt_modal_add_customer_close"), n = FormValidation.formValidation(r, {
                fields: {
                    percentage: {
                        validators: {
                            notEmpty: {
                                message: "Payout percentage is required"
                            }
                        }
                    },
					cycle: {
                        validators: {
                            notEmpty: {
                                message: "Payout cycle is required"
                            }
                        }
                    }
                },
            ...
            e.querySelectorAll('[data-kt-customer-table-filter="delete_row"]').forEach((e) => {
                e.addEventListener("click", function (e) {
                    ...
                    Swal.fire({
                        ...
                        if(e.value) {
                            $.ajax({
                            url: "http://stakefield-portal.test:8080/company/"+id,
                            type: 'DELETE',
    dataType: 'json',
    data:{
        'id': id,
  ...
  // something like $(this).hide() (only something useful, probably) :P
    ...
    error: function(request,msg,error) {
        // handle failure
                            ...
                            Swal.fire({ text: "Selected companies was not deleted.", icon: "error", buttonsStyling: !1, confirmButtonText: "Ok, got it!", customClass: { confirmButton: "btn fw-bold btn-primary" } });
                        }
                    });
                });
        };
...
function editBox(id) {
    ...
    success: function(result) {
		...
		$("#modal-head").text("Edit Company");
		$("#percentage").val(result.data.payout_percentage);
		$("#cycle").val(result.data.payout_cycle);
		$("#mode").val('edit');
		$("#listid").val(id);
    },
    error: function(request,msg,error) {
