							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Client Listing</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                        ...
                                                        <th class="min-w-125px">Legal Company Name</th>
													...
													<tr>
														...
														<td>
															<div class="form-check form-check-sm form-check-custom form-check-solid">
																<input class="form-check-input" name="deleteArray[]" type="checkbox" value="{{$user->id}}" />
															</div>
														</td>
														<!--end::Checkbox-->
														<!--begin::Name=-->
														...
														<td class="text-end">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<div class="menu-item px-3">
																	<a onclick="editBox({{$user->id}})" class="menu-link px-3">Edit</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
									...
									<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
										...
										<div class="modal-dialog modal-dialog-centered mw-650px">
											...
											<div class="modal-content">
												<!--begin::Form-->
												<form class="form"  method="post" id="kt_modal_add_customer_form" data-kt-redirect="{{route('clientlogin.index')}}">
													@csrf
                                                <!--begin::Modal header-->
													<div class="modal-header" id="kt_modal_add_customer_header">
														<!--begin::Modal title-->
														<h2 class="fw-bold" id="modal-head">Add Client</h2>
														<!--end::Modal title-->
														<!--begin::Close-->
													...
													<div class="modal-body py-10 px-lg-17">
														...
														<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
															...
															<div class="d-flex flex-column mb-7 fv-row">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<select name="company" id="company" aria-label="Select a company" data-control="select2" data-placeholder="Select a Company..." data-dropdown-parent="#kt_modal_add_customer" class="form-select form-select-solid fw-bold">
																		<option value="">Select a Company...</option>
																		@foreach($companies as $company)
																		<option value="{{$company->id}}">({{$company->payout_percentage}},{{$company->payout_cycle}})</option>
																		@endforeach
																	</select>
																	<!--end::Input-->
															</div>
															...
															<div class="fv-row mb-7">
																<!--begin::Label-->
																<label class="required fs-6 fw-semibold mb-2">Legal Company Name</label>
																<!--end::Label-->
																<!--begin::Input-->
																<input type="text" class="form-control form-control-solid" placeholder="Legal Company Name" name="legalname" id="legalname" value="" />
																<!--end::Input-->
															</div>
															<!--end::Input group-->
															<!--begin::Input group-->
															<div class="fv-row mb-7">
																<!--begin::Label-->
																<label class="required fs-6 fw-semibold mb-2">Contact Name</label>
																<!--end::Label-->
																<!--begin::Input-->
																<input type="text" class="form-control form-control-solid" placeholder="Contact Name" name="contactname" id="contactname" value="" />
																<!--end::Input-->
															</div>
															<!--end::Input group-->
															<!--begin::Input group-->
															<div class="fv-row mb-15">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<input type="text" class="form-control form-control-solid" placeholder="Company Address" name="address" id="address" />
																<!--end::Input-->
															</div>
															<!--end::Input group-->
															<div class="fv-row mb-7">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<input type="email" class="form-control form-control-solid" placeholder="" name="email" id="email" value="sean@dellito.com" />
																<!--end::Input-->
															</div>
															<div class="fv-row mb-15">
																<!--begin::Label-->
            ...
            e.querySelectorAll('[data-kt-customer-table-filter="delete_row"]').forEach((e) => {
                e.addEventListener("click", function (e) {
                    ...
                    Swal.fire({
                        ...
                        if(e.value) {
                            $.ajax({
                            url: "http://stakefield-portal.test:8080/clientlogin/"+id,
                            type: 'DELETE',
    dataType: 'json',
    data:{
        'id': id,
...
$.each($("input[name='deleteArray[]']:checked"), function() {
  ...
  // something like $(this).hide() (only something useful, probably) :P
    ...
    success: function(result) {
        Swal.fire({
                                text: "You have deleted all selected clients!.",
                                icon: "success",
                                buttonsStyling: !1,
                                confirmButtonText: "Ok, got it!",
                                customClass: {
    ...
    error: function(request,msg,error) {
        // handle failure
                            ...
                            Swal.fire({ text: "Selected clients was not deleted.", icon: "error", buttonsStyling: !1, confirmButtonText: "Ok, got it!", customClass: { confirmButton: "btn fw-bold btn-primary" } });
                        }
                    });
                });
        };
...
function editBox(id) {
	var url = "{{ route('clientlogin.edit', ":id") }}";
    ...
    success: function(result) {
		...
		$("#modal-head").text("Edit Client");
		$("#company").val(result.data.company_id);
		$('#company').select2().trigger('change');
		$("#legalname").val(result.data.legal_companyname);
		$("#contactname").val(result.data.name);
