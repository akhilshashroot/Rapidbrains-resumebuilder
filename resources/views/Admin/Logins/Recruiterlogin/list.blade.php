								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<li class="breadcrumb-item text-muted">Recruiters</li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-title">
												...
												<div class="d-flex align-items-center position-relative my-1">
													...
													<!--end::Svg Icon-->
													<input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Recruiters" />
												</div>
												<!--end::Search-->
											</div>
											<!--begin::Card title-->
											...
											<div class="card-toolbar">
												...
												<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
													...
													<!--end::Export-->
													<!--begin::Add customer-->
													<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Recruiter</button>
													<!--end::Add customer-->
												</div>
												<!--end::Toolbar-->
												<!--begin::Group actions-->
													...
													<tr>
														...
														<td>
															<div class="form-check form-check-sm form-check-custom form-check-solid">
																<input class="form-check-input" name="deleteArray[]" type="checkbox" value="{{$recruiter->id}}" />
															</div>
														</td>
														<!--end::Checkbox-->
														<!--begin::Name=-->
														<td>
															<a href="{{route('recruiter.signin',$recruiter->id)}}" target="_blank" class="text-gray-800 text-hover-primary mb-1">{{$recruiter->name}}</a>
														</td>
                                                        <td>{{$recruiter->email}}</td>
                                                        <td>{{$recruiter->phone}}</td>
                                                        <td>@if(!empty($recruiter->client)){{$recruiter->client->name}}@endif</td>
														...
														<td class="text-end">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<div class="menu-item px-3">
																	<a onclick="editBox({{$recruiter->id}})" class="menu-link px-3">Edit</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
																	<a href="#" class="menu-link px-3" data-id="{{$recruiter->id}}" data-kt-customer-table-filter="delete_row">Delete</a>
																</div>
																<!--end::Menu item-->
															</div>
															<!--end::Menu-->
									...
									<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
										...
										<div class="modal-dialog modal-dialog-centered mw-650px">
											...
											<div class="modal-content">
												<!--begin::Form-->
												<form class="form"  method="post" id="kt_modal_add_customer_form" data-kt-redirect="{{route('recruiterlogin.index')}}">
													@csrf
                                                <!--begin::Modal header-->
													<div class="modal-header" id="kt_modal_add_customer_header">
														<!--begin::Modal title-->
														<h2 class="fw-bold" id="modal-head">Add Recruiter</h2>
														<!--end::Modal title-->
														<!--begin::Close-->
            ...
            e.querySelectorAll('[data-kt-customer-table-filter="delete_row"]').forEach((e) => {
                e.addEventListener("click", function (e) {
                    ...
                    Swal.fire({
                        ...
                        if(e.value) {
                            $.ajax({
                            url: "http://stakefield-portal.test:8080/recruiterlogin/"+id,
                            type: 'DELETE',
    dataType: 'json',
    data:{
        'id': id,
        ...
        n = () => {
            ...
            o.forEach((t) => {
                ...
                n.addEventListener("click", function () {
                    Swal.fire({
                        text: "Are you sure you want to delete selected recruiters?",
                        icon: "warning",
                        showCancelButton: !0,
                        buttonsStyling: !1,
                        confirmButtonText: "Yes, delete!",
...
$.each($("input[name='deleteArray[]']:checked"), function() {
  ...
  // something like $(this).hide() (only something useful, probably) :P
                            ...
                            $.ajax({
                            url: "{{route('recruiter_massdelete')}}",
                            type: 'POST',
    dataType: 'json',
    data:{
        'ids': values,
    ...
    success: function(result) {
        Swal.fire({
                                text: "You have deleted all selected recruiters!.",
                                icon: "success",
                                buttonsStyling: !1,
                                confirmButtonText: "Ok, got it!",
                                customClass: {
    ...
    error: function(request,msg,error) {
        // handle failure
                            ...
                            Swal.fire({ text: "Selected recruiters was not deleted.", icon: "error", buttonsStyling: !1, confirmButtonText: "Ok, got it!", customClass: { confirmButton: "btn fw-bold btn-primary" } });
                        }
                    });
                });
        };
...
function editBox(id) {
	var url = "{{ route('recruiterlogin.edit', ":id") }}";
    ...
    success: function(result) {
		...
		$("#modal-head").text("Edit Recruiter");
